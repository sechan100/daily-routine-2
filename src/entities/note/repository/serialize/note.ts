import { UNGROUPED_GROUP_NAME } from '@/entities/routine-like';
import { fileAccessor } from '@/shared/file/file-accessor';
import { Day } from "@/shared/period/day";
import dedent from "dedent";
import { TFile } from 'obsidian';
import { RoutineNote } from "../../model/note";
import { NoteRoutineGroup, NoteRoutineLike, isNoteRoutine, isNoteRoutineGroup } from "../../model/note-routine-like";
import { Task } from "../../model/task";
import { deserializeNoteRoutine, deserializeNoteRoutineGroup, serializeNoteRoutineGroup } from "./routine";
