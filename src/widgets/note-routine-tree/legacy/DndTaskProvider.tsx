...
// interface DndTaskProviderProps {
//   task: Task;
//   onOptionMenu: (m: Menu, task: Task) => void | Promise<void>;
//   onTaskReorder: (note: RoutineNote, task: Task) => void;
//   onStateChange: (task: Task) => void;
//   className?: string;
// }
// export const DndTaskProvider = React.memo(({
//   task,
//   onTaskReorder,
//   onOptionMenu,
//   onStateChange,
//   className,
// }: DndTaskProviderProps) => {
